...
See [docs/PLAN.md](docs/PLAN.md) for principles, budgets, memory map, API, data formats, and milestones, and [docs/PREPARE.md](docs/PREPARE.md) for how to prepare every kind of data the engine consumes.
