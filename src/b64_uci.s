...
;
; After Gideon Zweijtzer, Command Interface documentation; DOS command bytes
; and the 3.15 unlock sequence after xahmol, UltimateDemo2026
; (ultimate_common_lib.c, ultimate_dos_lib.c).  Changed: only the DOS target
; and three commands are implemented, and response text is discarded; the
; engine wants the effect, not the message.  See CREDITS.md.
