...
;
; After Gideon Zweijtzer, Ultimate Audio Register API v0.2; the 6-bit volume
; and channel layout confirmed against xahmol's UltimateDemo2026 (audio.h).
; As is.  See CREDITS.md.
; Channel n at
