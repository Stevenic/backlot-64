...
| 3 | + Ultimate Audio | $DF20 idle status 0, silent test loop raises the end flag | 7 PCM channels straight from the REU: `b64_pcm_*`, the PCM opcode. |
